...
type MultiVideoCallScreenNavigationProp = StackNavigationProp<RootStackParamList, 'MultiVideoCallScreen'>;
type MultiVideoCallScreenRouteProp = RouteProp<RootStackParamList, 'MultiVideoCallScreen'>;
...
export default function MultiVideoCallScreen({ navigation, route }: Props) {
  return <VideoCallScreen navigation={navigation as any} route={route as any} />;
}
